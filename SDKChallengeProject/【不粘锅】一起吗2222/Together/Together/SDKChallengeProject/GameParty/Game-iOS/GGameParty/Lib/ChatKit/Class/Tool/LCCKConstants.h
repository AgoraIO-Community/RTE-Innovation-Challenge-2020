...
#pragma mark - Lofter增加的
static NSString *const GGLCCKNotificationMessageMemberRemoved = @"GGLCCKNotificationMessageMemberRemoved";

static NSString *const GGLCCKNotificationMessageMemberAdded = @"GGLCCKNotificationMessageMemberAdded";
#pragma mark - Lofter增加的
/**
 *  消息对方已读，通知聊天页面更改消息状态
 */

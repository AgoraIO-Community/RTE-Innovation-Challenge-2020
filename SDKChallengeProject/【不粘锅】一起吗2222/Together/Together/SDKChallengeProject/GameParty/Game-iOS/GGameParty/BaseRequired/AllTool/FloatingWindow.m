...
@property (nonatomic, strong) GGTeamRoomViewController *teamRoomVc;
...
#pragma mark--- 开始和结束
- (void)startWithTime:(NSInteger)time presentview:(UIView *)presentView inRect:(CGRect)rect presentController:(GGTeamRoomViewController *)controller
{
    self.teamRoomVc = controller;
    self.hidden = NO;
...
//        [[NSNotificationCenter defaultCenter]postNotificationName:PUSH_TEAM_DETAIL_NOTIFATION object:self.teamRoomVc];

...
/// <summary>
/// This editor class renders the custom inspector for the UDTEventHandlerMy MonoBehaviour
/// </summary>
[CustomEditor(typeof(UDTEventHandlerMy))]
public class UDTEventHandlerMyEditor : Editor
{
    ...
    {
        UDTEventHandlerMy m_UDTEventHandler = (UDTEventHandlerMy)target;

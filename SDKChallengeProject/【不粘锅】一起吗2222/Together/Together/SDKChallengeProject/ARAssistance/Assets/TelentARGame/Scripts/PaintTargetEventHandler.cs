...
/// </summary>
public class PaintTargetEventHandler : MonoBehaviour
{
    ...
    public UserDefEventHandler userDefineHandler;
...
*/
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        if (mTrackableBehaviour)
        {
            userDefineHandler.TargetFound(mTrackableBehaviour.TrackableName);
    ...
    protected virtual void OnTrackingLost()
    {
        ...
        if (mTrackableBehaviour)
        {
            userDefineHandler.TargetLost(mTrackableBehaviour.TrackableName);
            var rendererComponents = mTrackableBehaviour.GetComponentsInChildren<Renderer>(true);
            var colliderComponents = mTrackableBehaviour.GetComponentsInChildren<Collider>(true);
            var canvasComponents = mTrackableBehaviour.GetComponentsInChildren<Canvas>(true);

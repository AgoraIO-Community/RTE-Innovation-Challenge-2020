...
public class WatchMovieActivity extends BaseActivity {
...
//                    mLogView.logI("User offline, uid: " + (uid & 0xFFFFFFFFL));
    ...
    private void initUI() {
        ...
        wvPlayer = findViewById(R.id.at_watch_movie_wv_player);
        wvPlayer.getSettings().setJavaScriptEnabled(true);
        wvPlayer.setWebViewClient(new WebViewClient());
        wvPlayer.getSettings().setLayoutAlgorithm(WebSettings.LayoutAlgorithm.NARROW_COLUMNS);
        wvPlayer.getSettings().setUseWideViewPort(true);
        wvPlayer.loadUrl(getIntent().getStringExtra("url"));

        mCallBtn = findViewById(R.id.btn_call);
        mMuteBtn = findViewById(R.id.btn_mute);
        mSwitchCameraBtn = findViewById(R.id.btn_switch_camera);

        ToastUtil.makeLong(this,"喊上好友进房间一起看电影吧！");

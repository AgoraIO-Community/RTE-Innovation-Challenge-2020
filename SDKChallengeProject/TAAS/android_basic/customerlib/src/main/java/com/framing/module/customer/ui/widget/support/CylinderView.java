...
import com.framing.module.customer.ui.widget.support.utils.DensityUtil;
...
public class CylinderView extends View {
        ...
        if (!isAnimRunning) {
            ...
            mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    TLog.log("singleAnimValue: " + singleAnimValue + " singleAnimIndex: " + singleAnimIndex + " thickness: " + thickness + "  " + max);
    ...
    public void setAttentionText(String text){
        attentionText=text;
    }
    private void drawText(Canvas canvas){
        mainPaint.setColor(Color.WHITE);
        mainPaint.setTextAlign(Paint.Align.CENTER);
        mainPaint.setTextSize(DisplayUtils.sp2px(7));
        canvas.drawText(attentionText,0,attentionText.length(),DisplayUtils.dp2px(60f),DisplayUtils.dp2px(40f),mainPaint);
    }
    public void setData(ArrayList<Entry> data) {
        ...
        computationOrder();
        TLog.log("排序后: " + mEntrySourceList.toString());
        postInvalidate();
    }
            ...
            case ANIM_STATE_SINGLE:
                ...
                for (int i = 0; i < singleAnimIndex; i++) {
                    if (i < mEntrySourceList.size()) {
                        ...
                        TLog.log("tempThickNess: " + tempThickNess);

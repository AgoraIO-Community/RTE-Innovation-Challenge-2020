package com.framing.module.customer.ui.widget.support;
...
import com.framing.module.customer.ui.widget.support.utils.LinearGradientUtil;
import com.framing.module.customer.ui.widget.support.utils.ParrotPillarNew;
import com.framing.module.customer.ui.widget.support.utils.Utils;
...
public class ParrotViewNew extends View {
    ...
    //柱子最大长度
    private float mMaxLength = DisplayUtils.dp2px(70);
    //柱子间隔
    private float mInterval = 0.3f;

    //圆心半径
    private float mCenterR = DisplayUtils.dp2px(20);;
    //圆心内半径
    private float mCenterInsideR = mCenterR - DisplayUtils.dp2px(4);
    //圆心边粗
    private float mCenterThick = DisplayUtils.dp2px(1);;
    //圆心颜色
    private int mCenterColor = Color.parseColor("#01EAFF");
    //圆心背景色
    private int mCenterBgColor = Color.parseColor("#80101851");
    //圆心距右偏移量
    private float mCenterMarginRight = DisplayUtils.dp2px(10);
    //圆心距上偏移量
    private float mCenterMarginTop =DisplayUtils.dp2px(0);
    //圆心坐标
    ...
    //文字嵌入圆弧距离
    private float mEmbeddedArcDistanceMax = 0;
    private float mEmbeddedArcDistanceMin = 0;
    private float mEmbeddedArcDistanceNow;
    //文字距离圆弧距离
    private float mPaddingText = DisplayUtils.dp2px(3);
    //文字大小
    private float mMaxTextSize = DisplayUtils.dp2px(15);
    ...
    public void setData(ArrayList<ParrotPillarNew> mParrotPillarNews, int animType) {
        ...
        TLog.log("mMaxValue: " + mMaxValue + " mParrotPillarNews:" + mParrotPillarNews.toString());

...
- (CALayer *)pulsingLayer:(CGRect)rect animation:(CAAnimationGroup *)animationGroup {
    ...
    if (_animationType == AnimationTypeWithBackground) {
        pulsingLayer.backgroundColor = ColorWithAlpha(241, 241, 241, 0.5).CGColor;
        pulsingLayer.borderWidth = 0.5;
    } else {
        pulsingLayer.borderWidth = 1.f;
    }
    
    pulsingLayer.borderColor = ColorWithAlpha(241, 241, 241, 0.5).CGColor;
...
- (CAKeyframeAnimation *)backgroundColorAnimation {
    ...
    backgroundColorAnimation.values = @[(__bridge id)ColorWithAlpha(241, 241, 241, 0.5).CGColor,
                                        (__bridge id)ColorWithAlpha(241, 241, 241, 0.5).CGColor,
                                        (__bridge id)ColorWithAlpha(241, 241, 241, 0.5).CGColor,
                                        (__bridge id)ColorWithAlpha(241, 241, 241, 0).CGColor];
...
- (CAKeyframeAnimation *)borderColorAnimation {
    ...
    borderColorAnimation.values = @[(__bridge id)ColorWithAlpha(241, 241, 241, 0.5).CGColor,
                                    (__bridge id)ColorWithAlpha(241, 241, 241, 0.5).CGColor,
                                    (__bridge id)ColorWithAlpha(2241, 241, 241, 0.5).CGColor,
                                    (__bridge id)ColorWithAlpha(241, 241, 241, 0).CGColor];
...
- (CAKeyframeAnimation *)blackBorderColorAnimation {
    ...
    borderColorAnimation.keyPath = @"borderColor";
    borderColorAnimation.values = @[(__bridge id)ColorWithAlpha(241, 241, 241, 0.4).CGColor,
                                    (__bridge id)ColorWithAlpha(241, 241, 241, 0.4).CGColor,
                                    (__bridge id)ColorWithAlpha(241, 241, 241, 0.1).CGColor,
                                    (__bridge id)ColorWithAlpha(241, 241, 241, 0).CGColor];
    borderColorAnimation.keyTimes = @[@0.3,@0.6,@0.9,@1];
    return borderColorAnimation;
}

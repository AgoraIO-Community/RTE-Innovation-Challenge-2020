 ...
 * The video display mode.
 */
enum RENDER_SOURCE_TYPE {
  /**
   * 0: Render for the source from camera capture(default).
   */
  RENDER_SOURCE_CAMERA = 0,
  /**
   * 2: Render for the source from screen share
   */
  RENDER_SOURCE_SCREEN = 1,
  /**
   * 3: Render for the source from media player
   */
  RENDER_SOURCE_PLAYER = 2,
};

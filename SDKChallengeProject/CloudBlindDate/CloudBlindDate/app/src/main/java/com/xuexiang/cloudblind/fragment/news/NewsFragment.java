...
package com.xuexiang.cloudblind.fragment.news;
...
import com.xuexiang.cloudblind.activity.MainActivity;
import com.xuexiang.cloudblind.adapter.base.delegate.SimpleDelegateAdapter;
import com.xuexiang.cloudblind.adapter.base.delegate.SingleDelegateAdapter;
...
import com.xuexiang.cloudblind.fragment.blinddate.BlindDateFragment;
import com.xuexiang.cloudblind.utils.DemoDataProvider;
import com.xuexiang.cloudblind.utils.Utils;
        ...
        SingleDelegateAdapter bannerAdapter = new SingleDelegateAdapter(R.layout.include_head_view_banner) {
            ...
            public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
                ...
                banner.setSource(DemoDataProvider.getBannerList())
                        .setOnItemClickListener((view, item, position1) -> {
                            BannerInfo info = ObjectUtils.cast(item, BannerInfo.class);
                            if (info != null) {
                                Utils.goWeb(getContext(), info.linkUrl);
                            }
                        }).startScroll();
            }
        };
            ...
            protected void bindData(@NonNull RecyclerViewHolder holder, int position, AdapterItem item) {
                if (item != null) {
                    ...
                    holder.click(R.id.ll_container, v -> {
                                if (position == 0) {
                                    MainActivity activity = ObjectUtils.cast(getActivity(), MainActivity.class);
                                    if (activity != null) {
                                        activity.updateCurrentIndex(BlindDateFragment.INDEX_BLIND_DATE);
                                    }
                                } else {
                                    XToastUtils.toast(item.getTitle() + "功能正在开发中...");
                                }
                            }
                    );
                }

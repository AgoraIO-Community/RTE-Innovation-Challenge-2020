...
public class GameFragment extends Fragment implements View.OnClickListener {
    ...
    private void setViewClick() {
        ...
        mBinding.seeCourse.setOnClickListener(this);
    }

    private void initNowPlayerDetail() {

        boolean isFirst = SPUtils.getBoolean(this.getContext(),"isFirst");
        //默认是第一次进行 为true
        ...
        if(isFirst){
            ...
            mBinding.userName.setText(SPUtils.getString(this.getContext(),"name"));
            mBinding.userUid.setText(SPUtils.getString(this.getContext(),"uid"));
            Glide.with(this.getContext()).load(SPUtils.getString(this.getContext(),"url")).dontAnimate().into(mBinding.userAvatar);
        }
    ...
    private void initPopWindow() {
        ...
        noticePopupWindows.getSure().setOnClickListener(view -> {
            ...
            if(!nowName.isEmpty()){
                ...
                mBinding.userName.setText(nowName);
                mBinding.userUid.setText(uid);
                nowPlayer = new PlayerInfo(nowName,uid);
                SPUtils.setString(this.getContext(),"url",nowPlayer.getUrl());
                Glide.with(this.getContext()).load(nowPlayer.getUrl()).into(mBinding.userAvatar);
                ...
                nowPlayer.save(new SaveListener<String>() {
                    ...
                    public void done(String objectId, BmobException e) {
                        if(e==null){
                            ...
                            showToast("注册失败");
                            SPUtils.setBoolean(getContext(),"isFirstIn",true);
                            SPUtils.setBoolean(getContext(),"isFirst",true);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.see_course:
                Intent intent = new Intent(this.getContext(), CourseActivity.class);

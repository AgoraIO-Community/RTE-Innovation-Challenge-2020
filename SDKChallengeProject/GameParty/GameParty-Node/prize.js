...
var DB_PRIZE = 'tb_Prize'
var DB_PRIZE_USER = 'tb_Prize_User'
var DB_PRIZE_SOURCE = 'tb_Prize_Source'
var REGISTER_SOURCEID = '5baba1a917d009005ed5e863'
...
// //这里需要改进,必须是非匿名用户才执行.
//     var isAnmouys = request.object.isAnonymous();
//     console.log(isAnmouys);
//     if(!isAnmouys){
//         var query = new AV.Query(DB_PRIZE);
//         query.equalTo('status', false);
//         query.equalTo('type', '1');
//         return query.first({useMasterKey: true}).then(function (results) {
//             //1.取出一个奖品并保存更新状态为不可用,填充领奖用户字段
//             console.log(results);
//             var prize = AV.Object.createWithoutData(DB_PRIZE, results.toJSON().objectId);
//             prize.set('status', true);
//             prize.set('user', request.object);
//             prize.fetchWhenSave = true;
    
//             var userprize = AV.Object.extend(DB_PRIZE_USER);
//             var userprizetodo = new userprize();
    
//             userprizetodo.set('user', request.object);
//             userprizetodo.set('prize', prize);
//             var source = AV.Object.createWithoutData(DB_PRIZE_SOURCE, REGISTER_SOURCEID);
//             userprizetodo.set('source', source);
//             var objects = [prize, userprizetodo];
    
//             return AV.Object.saveAll(objects);
//         }).then(function (res) {
//             console.log('新注册用户已发放游戏奖励');
//         });
//     }

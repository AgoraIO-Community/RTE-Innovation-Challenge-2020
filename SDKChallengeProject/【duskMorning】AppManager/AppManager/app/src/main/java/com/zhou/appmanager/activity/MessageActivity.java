package com.zhou.appmanager.activity;
...
import com.zhou.appmanager.MyAdapter.MessageAdapter;
import com.zhou.appmanager.R;
import com.zhou.appmanager.core.AMApplication;
import com.zhou.appmanager.core.ChatManager;
import com.zhou.appmanager.model.MessageBean;
import com.zhou.appmanager.model.MessageListBean;
import com.zhou.appmanager.util.ImageUtil;
...
public class MessageActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChatManager = AMApplication.the().getChatManager();
    ...
    private void doLogin() {
        mRtmClient.login(null, mUserId, new ResultCallback<Void>() {
            ...
            public void onSuccess(Void responseInfo) {
                Log.i(TAG, "login success  " + mUserId);
...
//        finish();
    ...
    private void createAndJoinChannel() {
        ...
        mRtmChannel = mRtmClient.createChannel("AppManagerRoom", new MyChannelListener());
        if (mRtmChannel == null) {
            Log.e(TAG,"channel 创建为空，加入失败");
        ...
        mRtmChannel.join(new ResultCallback<Void>() {
            ...
            @Override
            public void onFailure(ErrorInfo errorInfo) {
                Log.e(TAG, "join" +" channel failed  " + errorInfo.getErrorCode() + "  " + errorInfo.getErrorDescription());
                runOnUiThread(() -> {
                    showToast(getString(R.string.join_channel_failed));
                    finish();
                });
